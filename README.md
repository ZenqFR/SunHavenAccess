...
- **Écrans en colonnes** (création de personnage : catégories à gauche, personnalisation au centre, informations à droite) : **Ctrl+gauche/droite** saute d'une colonne à l'autre, annonce laquelle en préfixe de l'élément atteint, et conserve la hauteur qu'on avait. Découpage **géométrique**, par les grands écarts horizontaux entre éléments — ce que fait l'œil, et surtout indépendant de la hiérarchie Unity de l'écran, invérifiable sans lancer le jeu. Volontairement **additif** : les flèches seules parcourent l'écran comme avant, donc un découpage erroné fait atterrir au mauvais endroit avec Ctrl mais ne casse rien de ce qui fonctionnait. Structure des trois colonnes rapportée en jeu par l'utilisateur.
